...
echo "#!/bin/sh -l
#SBATCH --output=/home/chan1074/dp_naivebayes/job_outputs/check_CI_simulated_objpert_1000_pb200_R200.out
#SBATCH --error=/home/chan1074/dp_naivebayes/job_outputs/check_CI_simulated_objpert_1000_pb200_R200.err
module load r/4.4
cd \$SLURM_SUBMIT_DIR
run_file='check_coverage_objpert_1000.r'
echo \$run_file
